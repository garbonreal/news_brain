...
class IscSpider(scrapy.Spider):
    name = "isc"
    start_urls = ["https://www.isc.org.cn/category/7349.html"]

    url = "https://www.isc.org.cn/category/7349_{}.html"
    page_num = 2
