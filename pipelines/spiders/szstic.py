...
class SzsticGovSpider(scrapy.Spider):
    name = "szstic"
    start_urls = ["http://stic.sz.gov.cn/xxgk/tzgg/index.html"]

    url = "http://stic.sz.gov.cn/xxgk/tzgg/index_{}.html"
    page_num = 2
    ...
    def parse(self, response):
        ...
        li_list = response.xpath("//div[@class='conter_listCont AllListCon']/ul/li")
        # 将new_list数据写入到文件中
