...
class BjfgwSpider(scrapy.Spider):
    name = "bjfgw"
    start_urls = ["http://fgw.beijing.gov.cn/gzdt/tztg/index.htm"]

    url = "http://fgw.beijing.gov.cn/gzdt/tztg/index_{}.htm"
    page_num = 1
    ...
    def parse(self, response):
        ...
        for li in li_list:
            ...
            news_link = "http://fgw.beijing.gov.cn/gzdt/tztg" + li.xpath(".//a/@href").extract_first().replace("./", "/")
