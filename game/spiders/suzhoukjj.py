...
class SuZhouKjjSpider(scrapy.Spider):
    name = "suzhoukjj"
    start_urls = ["https://kjj.suzhou.gov.cn/szkj/kjdt/common_list.shtml",
                  "https://kjj.suzhou.gov.cn/szkj/sxdt/common_list.shtml"]
    tag = {"kjdt": ["苏州科技", 2], "sxdt": ["市县动态", 2]}
    url = "https://kjj.suzhou.gov.cn/szkj/{}/common_list_{}.shtml"
    ...
    def parse(self, response):
        ...
        for ul in ul_list:
            ...
            for li in li_list:
                ...
                news_link = "https://kjj.suzhou.gov.cn" + li.xpath(".//a/@href").extract_first()
                ...
                item["source"] = "苏州市科学技术局-" + self.tag[category][0]
                yield item
